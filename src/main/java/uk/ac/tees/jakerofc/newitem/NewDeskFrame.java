 ...
 * @author jake
 */
public class NewDeskFrame extends NewItemFrame{
    private JSpinner jsDraws, jsWidth, jsDepth;
    protected ItemPanel mainPanel;
    
    public NewDeskFrame() throws HeadlessException {
        super();
    ...
    protected void initCenter() {
        class DeskPanel extends ItemPanel implements ActionListener {
